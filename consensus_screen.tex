...
\newcommand{\startinline}{\renewenvironment{itemize}{\begin{itemize*}}{%
    \end{itemize*}\ignorespacesafterend
}
\newcommand{\stopinline}{\renewenvironment{itemize}{\begin{itemize}}{%
    \end{itemize}\ignorespacesafterend
}
...
* Seize something dear to them 
* Blackmail them 
* Introduce a new enemy agent 
* Spring an elaborate trap 
* Manipulate an Ally 
* Demonstrate Power 
* Appear More Reasonable 
* Lookout for (even) non-Rending magic 
...
• Convert an Ally • Enforce Emotional barriers • Respond
Disproportionally
...
• Overcompensate • Goad Someone into Overreacting • Grind to a Halt •
Undermine Someone
