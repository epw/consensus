...
\begin{multicols}{3}
  ...
  \begin{move}
    When you \TRIGGER{impose your will} on someone, roll +Will:
  ...
  \begin{move}
    When you \TRIGGER{outmaneuver, outpace, or outfox}, roll +Grace.
  ...
  \begin{move}
    When you \TRIGGER{backlash} from Discord, roll +Discord, then reset
    Discord to 0.
