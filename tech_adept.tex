...
\renewcommand{\Paradigms}{
  \PARADIGM{Reality has an API}{Changing a single variable, magic done from a terminal  }\
  
           {(choose one) Living things, magic that affects only part of an object, I can only change a single variable at a time  }\
