...
\begin{multicols}{3}
  ...
  \begin{move}
    When you \TRIGGER{suffer harm}, roll +Harm suffered, after
    armor. On a 10+, the GM can choose 1:
    \begin{itemize}
      \setlength\itemsep{0em}
    ...
    \item Take the full Harm of the attack, before it was reduced by
      armor. If you already took the full Harm of the attack, take
      +1 Harm.
  ...
  \begin{move}
    ...
    an Anchor in order to stablize. Describe how you spiritually cut
