...
On a miss: Lose another Anchor. The MC will tell you which one and how.
  ...
  \begin{move}
    At the \TRIGGER{end of session}: note any effects that lasted "until end of session," but should continue into the next. Then, ask yourselves these questions as a group. For every one you answer “yes” to, everyone marks experience.
