...
\begin{multicols}{3}
  ...
  \begin{move}
    When you \TRIGGER{suffer harm} (even 0 harm), roll +Harm suffered. On a 10+, the MC can choose 1:
    \begin{itemize}
      \setlength\itemsep{0em}
  ...
  \begin{move}
    ...
    Mages, and you \TRIGGER{begin a ritual} of magical power, have
  ...
  \begin{move}
    ...
    effect is greater than it otherwise would be. The MC will tell you
    how.
  \end{move}  
