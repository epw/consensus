...
\renewcommand{\Trivialized}{or trivialized?** Because they thought I was broken, because I was uneducated, because of my looks, \BLANK}
\renewcommand{\Questioned}{ed?** Because of my obsessions, because I'm too different, because who I am hasn't changed, \BLANK}
...
\renewcommand{\Auras}{Expansive aura, sucking aura, insinuating aura, kaleidoscope aura, tantalizing aura}
...
\item : (pick one) My last gift from \BLANK before they left
...
\renewcommand{\MoveExplanation}{The Inspired gets the \textbf{Source} move, and 2 other moves of your choice.}
\renewcommand{\MoveSpacing}{0em}
\renewcommand{\Moves}{
  \DEFAULTMOVE{Source}{You've identified the source of your inspiration. When \TRIGGER{your Source first becomes present in a scene}, hold 3. At any time that your source is present for the rest of the scene, spend your Hold 1-for-1 to:{\small
\begin{itemize}
\setlength\itemsep{-.5em}
\item Draw attention to your Source
\item Give someone (including yourself) +1 to a roll they just made if it would change the result, describing how your Source helps them do it
\item Bring your positive tag into play, narrating what it means for the moment\end{itemize}}
}
...
\renewcommand{\Paradigms}{
  \PARADIGM{I Bend the Rules through my Source}{Mental magic, Time-affecting magic  }\
           ...
           {(choose one) Magic that reenforces the status quo, magic that doesn't protect my Source, time-affecting magic  }\
  ...
  \PARADIGM{My Source Lets me See the True Nature of Things}{Divinations, Transmutations  }\
           ...
           {(choose one) Obscuring magic, changing things that are Static, My magic must cause a transformation  }\
...
\begin{itemize}
\item - Your source can be concealed, protected, or otherwise removed from a dangerous situation (+safe)

\item - Your source gives you heightened senses (+alert)

\item - Your source lets you understand magic as its caster understands it (+sense)

\item - Your source makes you feel more alive, it gives you a rush (+invigorating)

\item - Your source helps you get people to go along with what you want (+social)
...
\begin{itemize}
\item - Your source is dangerous, socially unacceptable, or otherwise something you must hide or face consequences. (+forbidden)

\item - Your source is rare or hard to find. (+rare)

\item - Your source is immobile, unportable, or otherwise impossible to bring with you (+immobile)

\item - You crave more and more of the source, you suffer without it (+addictive)

\item - Your source is short-lived, and its magical enhancements last but a moment (+quick)

\item - Your source often harms you, physically or otherwise (+dangerous)

\item - Your source makes your magic more unpredictable, you can't always control it or its effects (+chaotic)
