...
\newfontfamily\chapterfont[]{Kingthings Printingkit}
...
to go to in order to protect an Anchor? - Did you uncover a secret? -
Did you learn something that puts your paradigms in perspective, or
caused you to question them? - Did you expose the depths of your
humanity, to yourself or to someone else? - Did you witness loss,
selfishness, or pain born of magic?
...
``Allison opens the door to get into the taxi, and the driver looks you
in the eye, and as you recognize him, says `My Lady sends her regards,'
and drives off before you can react''*
...
``You try to speak across boundaries to him, but it's like his mind is a
mirrored sphere. You can't reach him, and add the restriction, `The
close-minded hears only themselves.'\,''*
...
``The ritual is being resisted by something with a deep hold over this
place. You all take 1 Discord, and at this rate it's going to get
worse.''*
...
\textbf{Mark one Code off every Foreshadow Status Track}
...
\textbf{Mark one Code off every Anchor Status Track}

Anchors require maintenance. The Status Tracks advancing represent this.

\textbf{Note all slipping Status Tracks}
...
\textbf{Review any effects that last session were decided to be extended
into this one}
...
\textbf{Perform moves triggered at start of session}
...
\textbf{Frame a scene and make a soft move}
...
\textbf{The Guru }is a teacher for a group of non-magical students. If
you want to be explicitly in charge of a group of sleepers, you want to
play a guru. Warning: This playbook is quite reactive until you get to
...
\subsubsection{Paradigm}\label{paradigm-1}}
...
harm to reference when \textbf{dealing damage}:
...
\section{Paradigm}\label{paradigm-2}}
...
\section{Anchors}\label{anchors-10}}
...
\subsubsection{Memories}\label{memories}}
