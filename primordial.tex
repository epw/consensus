...
\renewcommand{\Auras}{firey aura, dark aura, shifting aura, grey aura,
...
\renewcommand{\Moves}{
  ...
  \MOVE{Harvest}{When you \textbf{Rip the Power from a Being} roll
  ...
  \end{itemize}}
  \MOVE{Hunter}{When you \textbf{Track your Prey's Magical Trail} roll
  ...
  \end{itemize}}
  \MOVE{Serendipity}{Once per session, when you roll to \textbf{Use
