...
an advancement. Your first 5 advancements must come from the top category
on your playbook. Additional ones after that may come from
the top two sections. If you are not Tethered, any time you would be able
to choose from the top two you may also choose from the third section.
...
than 3 Anchors remaining, and the Add a Freedom advancement, which may
be taken any time.
...
might be, "My character is very gullible. For this session, his flag is 
'tell me a lie that I believe.'" The first time each other character does 
something that fulfils this flag, they mark experience.
