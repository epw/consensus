...
\renewcommand{\Description}{_I am the voice of the past that will always be_  }
...
\renewcommand{\Bodies}{young body, burly body, tantalizing body, able body, flashy body \BLANK}
...
\item _______ who is always there for me
\item  Allison, who taught me how to live
\item  _______, who finishes my duets
}
\renewcommand{\MemoryAnchorItems}{
\item The long-dead bouquet of flowers I was given for _______
\item  The headphones that _______ got for me
\item  The my mother brought back from a business trip.
}
\renewcommand{\Gear}{
\item 1 Savings
...
\renewcommand{\MoveExplanation}{The Pious gets the \textbf{Charming Voice} move, and 2 other moves of your choice.}
\renewcommand{\Moves}{
  \setlength\itemsep{-.25em}
  \DEFAULTMOVE{Charming Voice}{When you *Sell a Lie* using your voice to do so, you may roll +Without instead of +Dynamic\TRIGGER{}}
