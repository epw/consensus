...
\VAR{willpower['afterlist']}
  ...
  \begin{move}
    ...
    decides based on each Mage's contributions. Take into
    consideration each participant's Opposed, and the probability of
    Rending magic. Then, roll +Within. On a 10+, the ritual works as
